...
{
    internal static class RemoveWorkerEmailTemplate
    {
...
<body>
  <div class='container'>
    <h2>Removal Notice</h2>
    <p>Dear {workerName},</p>

    <p>
      You have been removed from the event <strong>{eventName}</strong> scheduled on <strong>{eventDate}</strong>.
    </p>

    <p>
      <strong>Venue:</strong> {eventVenue}<br/>
      <strong>Previous Role:</strong> {workerRole}
    </p>

    <p>
      If you believe this is a mistake or have questions, please contact your supervisor.
    </p>
    ...
    <div class='footer'>
      <p>This notification is confidential and intended only for {workerName}. If you are not the intended recipient, please disregard this message.</p>
    </div>
  </div>
</body>
</html>";
